...
namespace librealsense
{
    namespace frame_streamer
    {
        ...
        public:
            ...
            std::shared_ptr<profile> resolve(std::shared_ptr<streamer> str, const std::chrono::milliseconds& timeout = std::chrono::milliseconds(0));
            bool can_resolve(std::shared_ptr<streamer> str);
