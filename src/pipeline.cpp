...
namespace librealsense
{
    ...
    */
    ...
    pipeline::pipeline(std::shared_ptr<librealsense::context> ctx) : streamer::streamer(ctx) {}
    ...
    void pipeline::on_start(std::shared_ptr<frame_streamer::profile> profile)
    {
    ...
    frame_callback_ptr pipeline::get_callback()
    {
