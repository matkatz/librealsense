...
typedef enum rs2_frame_metadata_value
{
    ...
    RS2_FRAME_METADATA_FRAME_LASER_POWER_MODE               , /**< Laser power mode. Zero corresponds to Laser power switched off and one for switched on. deprecated replaced by  */
    ...
    RS2_FRAME_METADATA_FRAME_EMITTER_MODE                   , /**< Emitter mode: 0 – all emitters disabled. 1 – laser enabled. 2 – auto laser enabled. 3 – LED enabled.*/
