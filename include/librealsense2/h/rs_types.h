...
typedef struct rs2_streamer rs2_streamer;
typedef struct rs2_async_streamer rs2_async_streamer;
typedef struct rs2_sync_streamer rs2_sync_streamer;
typedef struct rs2_pipeline rs2_pipeline;
typedef struct rs2_streamer_profile rs2_streamer_profile;
