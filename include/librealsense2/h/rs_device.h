...
* \param[out] error         If non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
void rs2_update_fw_cpp(const rs2_device* device, const void* fw_image, int fw_image_size, rs2_fw_update_progress_callback* callback, rs2_error** error);
...
* \param[out] error         If non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
void rs2_update_fw(const rs2_device* device, const void* fw_image, int fw_image_size, rs2_fw_update_progress_callback_ptr callback, void* client_data, rs2_error** error);

/**
* Enter the device to FW update mode
* \param[in]  device     Device to update
* \param[out] error      If non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
void rs2_enter_to_fw_update_mode(const rs2_device* device, rs2_error** error);
